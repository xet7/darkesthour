...
pub export fn Exits() void {
    _ = printf("\nExits are: ");
    if ((@bitCast(c_int, @as(c_uint, exits)) & @as(c_int, 1)) != 0) {
        _ = printf("north ");
    }
    if ((@bitCast(c_int, @as(c_uint, exits)) & @as(c_int, 2)) != 0) {
        _ = printf("south ");
    }
    if ((@bitCast(c_int, @as(c_uint, exits)) & @as(c_int, 4)) != 0) {
        _ = printf("east ");
    }
    if ((@bitCast(c_int, @as(c_uint, exits)) & @as(c_int, 8)) != 0) {
        _ = printf("west ");
    }
}
pub export fn GameOver() void {
    isGameOver = @as(c_int, 1) != 0;
    if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 1)) != 0) {
        if (!struck) {
            struck = @as(c_int, 1) != 0;
    ...
    if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 4)) != 0) {
    ...
    } else if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 2)) != 0) {
    ...
    } else if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 32)) != 0) {
    ...
    } else if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 8)) != 0) {
...
pub export fn Inventory() void {
    _ = printf("\nINVENTORY:");
    if (@bitCast(c_int, @as(c_uint, items)) == @as(c_int, 0)) {
        _ = printf("\n  You don't have anything yet.");
        return;
    }
    if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 2)) != 0) {
        _ = printf("\n  Four heads of garlic");
    }
    if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 8)) != 0) {
        _ = printf("\n  A wood tent spike");
    }
    if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 16)) != 0) {
        _ = printf("\n  A plastic pumpkin with a light");
    }
    if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 32)) != 0) {
        _ = printf("\n  A gun with silver bullets");
    }
    if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 4)) != 0) {
        _ = printf("\n  A crucifix");
    }
    if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 128)) != 0) {
        _ = printf("\n  A $100 bill");
    }
    if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 1)) != 0) {
        _ = printf("\n  A pocket-size Bible");
    }
    if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 64)) != 0) {
        _ = printf("\n  A diamond ring");
    }
}
pub export fn Location0() void {
    exits = @bitCast(u8, @truncate(i8, @as(c_int, 2) | @as(c_int, 4)));
    player = 0;
    UpdateAI();
    ...
    while (true) {
        if (isGameOver) return;
        while (true) {
            switch (@bitCast(c_int, @as(c_uint, input[@intCast(c_uint, @as(c_int, 0))]))) {
                ...
                @as(c_int, 103) => {
                    if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 64)) != 0) {
                        ...
                        items |= @bitCast(u8, @truncate(i8, @as(c_int, 64)));
                        _ = printf("\nYou grab the ring.");
                    }
                    break;
                },
                @as(c_int, 108) => {
                    ...
                    if (@bitCast(c_int, @as(c_uint, vampire)) > @as(c_int, 7)) {
                    ...
                    if (!((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 64)) != 0) and !((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 1)) != 0)) {
...
pub export fn Location1() void {
    player = 1;
    exits = @bitCast(u8, @truncate(i8, (@as(c_int, 2) | @as(c_int, 4)) | @as(c_int, 8)));
    UpdateAI();
    if (isGameOver) return;
    ...
    while (true) {
        ...
        while (true) {
            switch (@bitCast(c_int, @as(c_uint, input[@intCast(c_uint, @as(c_int, 0))]))) {
                ...
                @as(c_int, 103) => {
                    if (!((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 2)) != 0)) {
                        items |= @bitCast(u8, @truncate(i8, @as(c_int, 2)));
                        _ = printf("\nYou grab the garlic.");
                    } else {
                        _ = printf("\nNothing here.");
                    }
...
pub export fn Location3() void {
    exits = @bitCast(u8, @truncate(i8, @as(c_int, 2) | @as(c_int, 8)));
    player = 3;
    UpdateAI();
    if (isGameOver) return;
    _ = printf("\nST. MARY'S CATHEDRAL");
    while (true) {
        ...
        while (true) {
            switch (@bitCast(c_int, @as(c_uint, input[@intCast(c_uint, @as(c_int, 0))]))) {
                ...
                @as(c_int, 103) => {
                    if ((@bitCast(c_int, @as(c_uint, vampire)) <= @as(c_int, 7)) and !((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 4)) != 0)) {
                        items |= @bitCast(u8, @truncate(i8, @as(c_int, 4)));
...
pub export fn Location4() void {
    exits = @bitCast(u8, @truncate(i8, (@as(c_int, 1) | @as(c_int, 2)) | @as(c_int, 4)));
    player = 4;
    UpdateAI();
    if (isGameOver) return;
    _ = printf("\nLOWLAND FIRE HALL");
...
pub export fn Location5() void {
    var tacos: u8 = 0;
    exits = @bitCast(u8, @truncate(i8, ((@as(c_int, 1) | @as(c_int, 2)) | @as(c_int, 4)) | @as(c_int, 8)));
    player = 5;
    UpdateAI();
    if (isGameOver) return;
    _ = printf("\nNIKO'S TACOS");
            ...
            switch (@bitCast(c_int, @as(c_uint, input[@intCast(c_uint, @as(c_int, 0))]))) {
                ...
                @as(c_int, 103) => {
                    if (@bitCast(c_int, @as(c_uint, vampire)) > @as(c_int, 7)) {
                        ...
                        tacos +%= 1;
                        if (@bitCast(c_int, @as(c_uint, tacos)) >= @as(c_int, 13)) {
                            _ = printf("\n%d tacos! If the vampire gets you, she\nwill be sucking salsa instead of blood!", @bitCast(c_int, @as(c_uint, tacos)));
                        } else if (@bitCast(c_int, @as(c_uint, tacos)) == @as(c_int, 0)) {
        ...
        while (true) {
            switch (@bitCast(c_int, @as(c_uint, input[@intCast(c_uint, @as(c_int, 0))]))) {
                ...
                @as(c_int, 116) => {
                    if (@bitCast(c_int, @as(c_uint, vampire)) > @as(c_int, 7)) {
                    ...
                    } else if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 1)) != 0) {
                        _ = printf("\n\"Thank you so much for finding my ring!\nI'm sorry I can't do more to help you.\"");
                    } else if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 64)) != 0) {
                        ...
                        items |= @bitCast(u8, @truncate(i8, @as(c_int, 1)));
                        items &= @bitCast(u8, @truncate(i8, ~@as(c_int, 64)));
                    } else {
...
pub export fn Location7() void {
    exits = @bitCast(u8, @truncate(i8, (@as(c_int, 1) | @as(c_int, 2)) | @as(c_int, 8)));
    player = 7;
    UpdateAI();
    if (isGameOver) return;
    _ = printf("\nCEMETERY");
    ...
    while (true) {
        ...
        while (true) {
            switch (@bitCast(c_int, @as(c_uint, input[@intCast(c_uint, @as(c_int, 0))]))) {
                ...
                @as(c_int, 103) => {
                    if (!((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 16)) != 0)) {
                        items |= @bitCast(u8, @truncate(i8, @as(c_int, 16)));
    ...
    while (true) {
        ...
        while (true) {
            switch (@bitCast(c_int, @as(c_uint, input[@intCast(c_uint, @as(c_int, 0))]))) {
                ...
                @as(c_int, 103) => {
                    if (!((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 8)) != 0)) {
                        items |= @bitCast(u8, @truncate(i8, @as(c_int, 8)));
    ...
    while (true) {
        ...
        while (true) {
            switch (@bitCast(c_int, @as(c_uint, input[@intCast(c_uint, @as(c_int, 0))]))) {
                ...
                @as(c_int, 103) => {
                    if (!((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 128)) != 0) and (@bitCast(c_int, @as(c_uint, vampire)) <= @as(c_int, 7))) {
                        items |= @bitCast(u8, @truncate(i8, @as(c_int, 128)));
                ...
                @as(c_int, 108) => {
                    if (@bitCast(c_int, @as(c_uint, vampire)) > @as(c_int, 7)) {
                        ...
                        if (!((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 128)) != 0) and !((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 32)) != 0)) {
...
pub export fn LocationC() void {
    if (isGameOver) return;
    exits = @bitCast(u8, @truncate(i8, @as(c_int, 1) | @as(c_int, 4)));
    player = 12;
    if (@bitCast(c_int, @as(c_uint, vampire)) > @as(c_int, 7)) {
        if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 1)) != 0) {
...
pub export fn LocationD() void {
    exits = @bitCast(u8, @truncate(i8, (@as(c_int, 1) | @as(c_int, 4)) | @as(c_int, 8)));
    player = 13;
    UpdateAI();
    if (isGameOver) return;
    _ = printf("\nWELLINGTON AVE.");
...
pub export fn LocationF() void {
    exits = @bitCast(u8, @truncate(i8, @as(c_int, 1) | @as(c_int, 8)));
    player = 15;
    UpdateAI();
    if (isGameOver) return;
    _ = printf("\nPAWN SHOP");
        ...
        while (true) {
            switch (@bitCast(c_int, @as(c_uint, input[@intCast(c_uint, @as(c_int, 0))]))) {
                ...
                @as(c_int, 116) => {
                    if (@bitCast(c_int, @as(c_uint, vampire)) > @as(c_int, 7)) {
                        _ = printf("\nNo one else here");
                    } else if ((@bitCast(c_int, @as(c_uint, items)) & @as(c_int, 128)) != 0) {
                ...
                @as(c_int, 103) => {
                    if (@bitCast(c_int, @as(c_uint, vampire)) > @as(c_int, 7)) {
                        ...
                        items &= @bitCast(u8, @truncate(i8, ~@as(c_int, 128)));
                        items |= @bitCast(u8, @truncate(i8, @as(c_int, 32)));
...
pub export fn Password() void {
    ...
    _ = printf("\r\n\nEnter password:  ");
    _ = memset(@ptrCast(?*anyopaque, @ptrCast([*c]u8, @alignCast(@import("std").meta.alignment([*c]u8), &input))), @as(c_int, 8), @bitCast(c_ulong, @as(c_long, @as(c_int, 8))));
    Input();
    temp = ReadNybble(input[@intCast(c_uint, @as(c_int, 0))]);
    if (@bitCast(c_int, @as(c_uint, temp)) == @as(c_int, 255)) {
        _ = printf("Invalid password.\r\n");
        return;
    }
    player = temp;
    temp = ReadNybble(input[@intCast(c_uint, @as(c_int, 1))]);
    if (@bitCast(c_int, @as(c_uint, temp)) == @as(c_int, 255)) {
        _ = printf("Invalid password.\r\n");
        return;
    }
    items = @bitCast(u8, @truncate(i8, @bitCast(c_int, @as(c_uint, temp)) << @intCast(@import("std").math.Log2Int(c_int), 4)));
    temp = ReadNybble(input[@intCast(c_uint, @as(c_int, 2))]);
    if (@bitCast(c_int, @as(c_uint, temp)) == @as(c_int, 255)) {
        _ = printf("Invalid password.\r\n");
        return;
    }
    items +%= @bitCast(u8, @truncate(i8, @bitCast(c_int, @as(c_uint, temp))));
    StartGame();
}
pub export fn Prompt() void {
    _ = printf("\n\n");
    Input();
    input[@intCast(c_uint, @as(c_int, 0))] = @bitCast(u8, @truncate(i8, tolower(@bitCast(c_int, @as(c_uint, input[@intCast(c_uint, @as(c_int, 0))])))));
    while (true) {
        switch (@bitCast(c_int, @as(c_uint, input[@intCast(c_uint, @as(c_int, 0))]))) {
            @as(c_int, 120) => {
                Exits();
            ...
            @as(c_int, 113) => {
                _ = printf("\nPassword: %x%02x\n\nPress ENTER/RETURN to exit.", @bitCast(c_int, @as(c_uint, player)), @bitCast(c_int, @as(c_uint, items)));
                _ = getchar();
                exit(@as(c_int, 0));
                return;
            },
...
pub export fn ReadNybble(arg_ch: u8) u8 {
    var ch = arg_ch;
    while (true) {
        switch (@bitCast(c_int, @as(c_uint, ch))) {
...
pub export fn Row(arg_n: u8) u8 {
    var n = arg_n;
    if (@bitCast(c_int, @as(c_uint, n)) < @as(c_int, 4)) return 0;
    if (@bitCast(c_int, @as(c_uint, n)) < @as(c_int, 8)) return 1;
    if (@bitCast(c_int, @as(c_uint, n)) < @as(c_int, 12)) return 2;
    return 3;
}
pub export fn ShowPassword() void {
    _ = printf("\nPassword: %x%02x\n\nPress ENTER/RETURN to go\nback to the main menu.", @bitCast(c_int, @as(c_uint, player)), @bitCast(c_int, @as(c_uint, items)));
    _ = getchar();
    isGameOver = @as(c_int, 1) != 0;
}
pub export fn StartGame() void {
    while (true) {
        switch (@bitCast(c_int, @as(c_uint, player))) {
            @as(c_int, 0) => {
                Location0();
                return;
            },
...
pub export fn UpdateAI() void {
    ...
    input[@intCast(c_uint, @as(c_int, 0))] = 'l';
    timer.static = @bitCast(u8, @truncate(i8, @bitCast(c_int, @as(c_uint, vampire)) - ((@bitCast(c_int, @as(c_uint, vampire)) >> @intCast(@import("std").math.Log2Int(c_int), 4)) * @as(c_int, 16))));
    vampire -%= @bitCast(u8, @truncate(i8, @bitCast(c_int, @as(c_uint, timer.static))));
    if (!isDay and (@divTrunc(@bitCast(c_int, @as(c_uint, vampire)), @as(c_int, 16)) == @bitCast(c_int, @as(c_uint, player)))) {
        GameOver();
        return;
    }
    timer.static +%= 1;
    if (@bitCast(c_int, @as(c_uint, timer.static)) == @as(c_int, 8)) {
        if (isDay) {
    ...
    vampire /= @bitCast(u8, @truncate(i8, @as(c_int, 16)));
    if (@bitCast(c_int, @as(c_uint, Row(vampire))) < @bitCast(c_int, @as(c_uint, Row(player)))) {
        vampire +%= @bitCast(u8, @truncate(i8, @as(c_int, 4)));
    } else if (@bitCast(c_int, @as(c_uint, Row(vampire))) > @bitCast(c_int, @as(c_uint, Row(player)))) {
        vampire -%= @bitCast(u8, @truncate(i8, @as(c_int, 4)));
    } else if (@bitCast(c_int, @as(c_uint, vampire)) < @bitCast(c_int, @as(c_uint, player))) {
        vampire +%= 1;
    } else {
        vampire -%= 1;
    }
    if (@bitCast(c_int, @as(c_uint, vampire)) == @bitCast(c_int, @as(c_uint, player))) {
        GameOver();
        return;
    }
    vampire *%= @bitCast(u8, @truncate(i8, @as(c_int, 16)));
...
pub export fn Input() void {
    var i: u8 = 0;
    while (@bitCast(c_int, @as(c_uint, i)) < @as(c_int, 8)) {
        input[i] = @bitCast(u8, @truncate(i8, getchar()));
        if (@bitCast(c_int, @as(c_uint, input[i])) == @as(c_int, '\n')) return;
        i +%= 1;
    }
}
pub export fn main() c_int {
    input[@intCast(c_uint, @as(c_int, 0))] = 'm';
    while (true) {
        isDay = @as(c_int, 1) != 0;
        isGameOver = @as(c_int, 0) != 0;
        player = 5;
        ...
        _ = printf("\n\nYour choice:  ");
        _ = fgets(@ptrCast([*c]u8, @alignCast(@import("std").meta.alignment([*c]u8), &input)), @as(c_int, 8), stdin);
    }
    return 0;
}
...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /snap/zig/6567/lib/include/stdarg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /snap/zig/6567/lib/include/stdarg.h:18:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /snap/zig/6567/lib/include/stdarg.h:19:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /snap/zig/6567/lib/include/stdarg.h:24:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /snap/zig/6567/lib/include/stdarg.h:27:9
