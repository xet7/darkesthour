...
#define BltBitMap(___srcBitMap, ___xSrc, ___ySrc, ___destBitMap, ___xDest, ___yDest, ___xSize, ___ySize, ___minterm, ___mask, ___tempA) \
	LP11(0x1e, LONG, BltBitMap , const struct BitMap *, ___srcBitMap, a0, WORD, ___xSrc, d0, WORD, ___ySrc, d1, struct BitMap *, ___destBitMap, a1, WORD, ___xDest, d2, WORD, ___yDest, d3, WORD, ___xSize, d4, WORD, ___ySize, d5, UBYTE, ___minterm, d6, UBYTE, ___mask, d7, PLANEPTR, ___tempA, a2,\
	, GRAPHICS_BASE_NAME)

#define BltTemplate(___source, ___xSrc, ___srcMod, ___destRP, ___xDest, ___yDest, ___xSize, ___ySize) \
	LP8NR(0x24, BltTemplate , const PLANEPTR, ___source, a0, WORD, ___xSrc, d0, WORD, ___srcMod, d1, struct RastPort *, ___destRP, a1, WORD, ___xDest, d2, WORD, ___yDest, d3, WORD, ___xSize, d4, WORD, ___ySize, d5,\
	, GRAPHICS_BASE_NAME)
...
#define TextLength(___rp, ___string, ___count) \
	LP3(0x36, WORD, TextLength , struct RastPort *, ___rp, a1, CONST_STRPTR, ___string, a0, UWORD, ___count, d0,\
	, GRAPHICS_BASE_NAME)

#define Text(___rp, ___string, ___count) \
	LP3(0x3c, LONG, Text , struct RastPort *, ___rp, a1, CONST_STRPTR, ___string, a0, UWORD, ___count, d0,\
	, GRAPHICS_BASE_NAME)
...
#define GetGBuffers(___anOb, ___rp, ___flag) \
	LP3(0xa8, BOOL, GetGBuffers , struct AnimOb *, ___anOb, a0, struct RastPort *, ___rp, a1, BOOL, ___flag, d0,\
	, GRAPHICS_BASE_NAME)
...
#define DrawEllipse(___rp, ___xCenter, ___yCenter, ___a, ___b) \
	LP5NR(0xb4, DrawEllipse , struct RastPort *, ___rp, a1, WORD, ___xCenter, d0, WORD, ___yCenter, d1, WORD, ___a, d2, WORD, ___b, d3,\
	, GRAPHICS_BASE_NAME)

#define AreaEllipse(___rp, ___xCenter, ___yCenter, ___a, ___b) \
	LP5(0xba, LONG, AreaEllipse , struct RastPort *, ___rp, a1, WORD, ___xCenter, d0, WORD, ___yCenter, d1, WORD, ___a, d2, WORD, ___b, d3,\
	, GRAPHICS_BASE_NAME)

#define LoadRGB4(___vp, ___colors, ___count) \
	LP3NR(0xc0, LoadRGB4 , struct ViewPort *, ___vp, a0, const UWORD *, ___colors, a1, WORD, ___count, d0,\
	, GRAPHICS_BASE_NAME)
...
#define SetRast(___rp, ___pen) \
	LP2NR(0xea, SetRast , struct RastPort *, ___rp, a1, UBYTE, ___pen, d0,\
	, GRAPHICS_BASE_NAME)

#define Move(___rp, ___x, ___y) \
	LP3NR(0xf0, Move , struct RastPort *, ___rp, a1, WORD, ___x, d0, WORD, ___y, d1,\
	, GRAPHICS_BASE_NAME)

#define Draw(___rp, ___x, ___y) \
	LP3NR(0xf6, Draw , struct RastPort *, ___rp, a1, WORD, ___x, d0, WORD, ___y, d1,\
	, GRAPHICS_BASE_NAME)

#define AreaMove(___rp, ___x, ___y) \
	LP3(0xfc, LONG, AreaMove , struct RastPort *, ___rp, a1, WORD, ___x, d0, WORD, ___y, d1,\
	, GRAPHICS_BASE_NAME)

#define AreaDraw(___rp, ___x, ___y) \
	LP3(0x102, LONG, AreaDraw , struct RastPort *, ___rp, a1, WORD, ___x, d0, WORD, ___y, d1,\
	, GRAPHICS_BASE_NAME)
...
#define InitArea(___areaInfo, ___vectorBuffer, ___maxVectors) \
	LP3NR(0x11a, InitArea , struct AreaInfo *, ___areaInfo, a0, APTR, ___vectorBuffer, a1, WORD, ___maxVectors, d0,\
	, GRAPHICS_BASE_NAME)

#define SetRGB4(___vp, ___index, ___red, ___green, ___blue) \
	LP5NR(0x120, SetRGB4 , struct ViewPort *, ___vp, a0, WORD, ___index, d0, UBYTE, ___red, d1, UBYTE, ___green, d2, UBYTE, ___blue, d3,\
	, GRAPHICS_BASE_NAME)
...
#define RectFill(___rp, ___xMin, ___yMin, ___xMax, ___yMax) \
	LP5NR(0x132, RectFill , struct RastPort *, ___rp, a1, WORD, ___xMin, d0, WORD, ___yMin, d1, WORD, ___xMax, d2, WORD, ___yMax, d3,\
	, GRAPHICS_BASE_NAME)

#define BltPattern(___rp, ___mask, ___xMin, ___yMin, ___xMax, ___yMax, ___maskBPR) \
	LP7NR(0x138, BltPattern , struct RastPort *, ___rp, a1, const PLANEPTR, ___mask, a0, WORD, ___xMin, d0, WORD, ___yMin, d1, WORD, ___xMax, d2, WORD, ___yMax, d3, UWORD, ___maskBPR, d4,\
	, GRAPHICS_BASE_NAME)

#define ReadPixel(___rp, ___x, ___y) \
	LP3(0x13e, ULONG, ReadPixel , struct RastPort *, ___rp, a1, WORD, ___x, d0, WORD, ___y, d1,\
	, GRAPHICS_BASE_NAME)

#define WritePixel(___rp, ___x, ___y) \
	LP3(0x144, LONG, WritePixel , struct RastPort *, ___rp, a1, WORD, ___x, d0, WORD, ___y, d1,\
	, GRAPHICS_BASE_NAME)

#define Flood(___rp, ___mode, ___x, ___y) \
	LP4(0x14a, BOOL, Flood , struct RastPort *, ___rp, a1, ULONG, ___mode, d2, WORD, ___x, d0, WORD, ___y, d1,\
	, GRAPHICS_BASE_NAME)

#define PolyDraw(___rp, ___count, ___polyTable) \
	LP3NR(0x150, PolyDraw , struct RastPort *, ___rp, a1, WORD, ___count, d0, const WORD *, ___polyTable, a0,\
	, GRAPHICS_BASE_NAME)

#define SetAPen(___rp, ___pen) \
	LP2NR(0x156, SetAPen , struct RastPort *, ___rp, a1, UBYTE, ___pen, d0,\
	, GRAPHICS_BASE_NAME)

#define SetBPen(___rp, ___pen) \
	LP2NR(0x15c, SetBPen , struct RastPort *, ___rp, a1, UBYTE, ___pen, d0,\
	, GRAPHICS_BASE_NAME)

#define SetDrMd(___rp, ___drawMode) \
	LP2NR(0x162, SetDrMd , struct RastPort *, ___rp, a1, UBYTE, ___drawMode, d0,\
	, GRAPHICS_BASE_NAME)
...
#define CMove(___copList, ___destination, ___data) \
	LP3NR(0x174, CMove , struct UCopList *, ___copList, a1, APTR, ___destination, d0, WORD, ___data, d1,\
	, GRAPHICS_BASE_NAME)

#define CWait(___copList, ___v, ___h) \
	LP3NR(0x17a, CWait , struct UCopList *, ___copList, a1, WORD, ___v, d0, WORD, ___h, d1,\
	, GRAPHICS_BASE_NAME)
...
#define InitBitMap(___bitMap, ___depth, ___width, ___height) \
	LP4NR(0x186, InitBitMap , struct BitMap *, ___bitMap, a0, BYTE, ___depth, d0, WORD, ___width, d1, WORD, ___height, d2,\
	, GRAPHICS_BASE_NAME)

#define ScrollRaster(___rp, ___dx, ___dy, ___xMin, ___yMin, ___xMax, ___yMax) \
	LP7NR(0x18c, ScrollRaster , struct RastPort *, ___rp, a1, WORD, ___dx, d0, WORD, ___dy, d1, WORD, ___xMin, d2, WORD, ___yMin, d3, WORD, ___xMax, d4, WORD, ___yMax, d5,\
	, GRAPHICS_BASE_NAME)
...
#define GetSprite(___sprite, ___num) \
	LP2(0x198, WORD, GetSprite , struct SimpleSprite *, ___sprite, a0, WORD, ___num, d0,\
	, GRAPHICS_BASE_NAME)

#define FreeSprite(___num) \
	LP1NR(0x19e, FreeSprite , WORD, ___num, d0,\
	, GRAPHICS_BASE_NAME)
...
#define MoveSprite(___vp, ___sprite, ___x, ___y) \
	LP4NR(0x1aa, MoveSprite , struct ViewPort *, ___vp, a0, struct SimpleSprite *, ___sprite, a1, WORD, ___x, d0, WORD, ___y, d1,\
	, GRAPHICS_BASE_NAME)
...
#define AllocRaster(___width, ___height) \
	LP2(0x1ec, PLANEPTR, AllocRaster , UWORD, ___width, d0, UWORD, ___height, d1,\
	, GRAPHICS_BASE_NAME)

#define FreeRaster(___p, ___width, ___height) \
	LP3NR(0x1f2, FreeRaster , PLANEPTR, ___p, a0, UWORD, ___width, d0, UWORD, ___height, d1,\
	, GRAPHICS_BASE_NAME)
...
#define ClipBlit(___srcRP, ___xSrc, ___ySrc, ___destRP, ___xDest, ___yDest, ___xSize, ___ySize, ___minterm) \
	LP9NR(0x228, ClipBlit , struct RastPort *, ___srcRP, a0, WORD, ___xSrc, d0, WORD, ___ySrc, d1, struct RastPort *, ___destRP, a1, WORD, ___xDest, d2, WORD, ___yDest, d3, WORD, ___xSize, d4, WORD, ___ySize, d5, UBYTE, ___minterm, d6,\
	, GRAPHICS_BASE_NAME)
...
#define FreeGBuffers(___anOb, ___rp, ___flag) \
	LP3NR(0x258, FreeGBuffers , struct AnimOb *, ___anOb, a0, struct RastPort *, ___rp, a1, BOOL, ___flag, d0,\
	, GRAPHICS_BASE_NAME)

#define BltBitMapRastPort(___srcBitMap, ___xSrc, ___ySrc, ___destRP, ___xDest, ___yDest, ___xSize, ___ySize, ___minterm) \
	LP9NR(0x25e, BltBitMapRastPort , const struct BitMap *, ___srcBitMap, a0, WORD, ___xSrc, d0, WORD, ___ySrc, d1, struct RastPort *, ___destRP, a1, WORD, ___xDest, d2, WORD, ___yDest, d3, WORD, ___xSize, d4, WORD, ___ySize, d5, UBYTE, ___minterm, d6,\
	, GRAPHICS_BASE_NAME)
...
#define SetRGB4CM(___colorMap, ___index, ___red, ___green, ___blue) \
	LP5NR(0x276, SetRGB4CM , struct ColorMap *, ___colorMap, a0, WORD, ___index, d0, UBYTE, ___red, d1, UBYTE, ___green, d2, UBYTE, ___blue, d3,\
	, GRAPHICS_BASE_NAME)
...
#define BltMaskBitMapRastPort(___srcBitMap, ___xSrc, ___ySrc, ___destRP, ___xDest, ___yDest, ___xSize, ___ySize, ___minterm, ___bltMask) \
	LP10NR(0x27c, BltMaskBitMapRastPort , const struct BitMap *, ___srcBitMap, a0, WORD, ___xSrc, d0, WORD, ___ySrc, d1, struct RastPort *, ___destRP, a1, WORD, ___xDest, d2, WORD, ___yDest, d3, WORD, ___xSize, d4, WORD, ___ySize, d5, UBYTE, ___minterm, d6, const PLANEPTR, ___bltMask, a2,\
	, GRAPHICS_BASE_NAME)
...
#define ScalerDiv(___factor, ___numerator, ___denominator) \
	LP3(0x2ac, UWORD, ScalerDiv , UWORD, ___factor, d0, UWORD, ___numerator, d1, UWORD, ___denominator, d2,\
	, GRAPHICS_BASE_NAME)

#define TextExtent(___rp, ___string, ___count, ___textExtent) \
	LP4(0x2b2, WORD, TextExtent , struct RastPort *, ___rp, a1, CONST_STRPTR, ___string, a0, WORD, ___count, d0, struct TextExtent *, ___textExtent, a2,\
	, GRAPHICS_BASE_NAME)
...
#define TextFit(___rp, ___string, ___strLen, ___textExtent, ___constrainingExtent, ___strDirection, ___constrainingBitWidth, ___constrainingBitHeight) \
	LP8(0x2b8, ULONG, TextFit , struct RastPort *, ___rp, a1, CONST_STRPTR, ___string, a0, UWORD, ___strLen, d0, const struct TextExtent *, ___textExtent, a2, const struct TextExtent *, ___constrainingExtent, a3, WORD, ___strDirection, d1, UWORD, ___constrainingBitWidth, d2, UWORD, ___constrainingBitHeight, d3,\
	, GRAPHICS_BASE_NAME)
...
#define ReadPixelLine8(___rp, ___xstart, ___ystart, ___width, ___array, ___tempRP) \
	LP6(0x300, LONG, ReadPixelLine8 , struct RastPort *, ___rp, a0, UWORD, ___xstart, d0, UWORD, ___ystart, d1, UWORD, ___width, d2, UBYTE *, ___array, a2, struct RastPort *, ___tempRP, a1,\
	, GRAPHICS_BASE_NAME)

#define WritePixelLine8(___rp, ___xstart, ___ystart, ___width, ___array, ___tempRP) \
	LP6(0x306, LONG, WritePixelLine8 , struct RastPort *, ___rp, a0, UWORD, ___xstart, d0, UWORD, ___ystart, d1, UWORD, ___width, d2, UBYTE *, ___array, a2, struct RastPort *, ___tempRP, a1,\
	, GRAPHICS_BASE_NAME)

#define ReadPixelArray8(___rp, ___xstart, ___ystart, ___xstop, ___ystop, ___array, ___temprp) \
	LP7(0x30c, LONG, ReadPixelArray8 , struct RastPort *, ___rp, a0, UWORD, ___xstart, d0, UWORD, ___ystart, d1, UWORD, ___xstop, d2, UWORD, ___ystop, d3, UBYTE *, ___array, a2, struct RastPort *, ___temprp, a1,\
	, GRAPHICS_BASE_NAME)

#define WritePixelArray8(___rp, ___xstart, ___ystart, ___xstop, ___ystop, ___array, ___temprp) \
	LP7(0x312, LONG, WritePixelArray8 , struct RastPort *, ___rp, a0, UWORD, ___xstart, d0, UWORD, ___ystart, d1, UWORD, ___xstop, d2, UWORD, ___ystop, d3, UBYTE *, ___array, a2, struct RastPort *, ___temprp, a1,\
	, GRAPHICS_BASE_NAME)
...
#define EraseRect(___rp, ___xMin, ___yMin, ___xMax, ___yMax) \
	LP5NR(0x32a, EraseRect , struct RastPort *, ___rp, a1, WORD, ___xMin, d0, WORD, ___yMin, d1, WORD, ___xMax, d2, WORD, ___yMax, d3,\
	, GRAPHICS_BASE_NAME)
...
#define ScrollRasterBF(___rp, ___dx, ___dy, ___xMin, ___yMin, ___xMax, ___yMax) \
	LP7NR(0x3ea, ScrollRasterBF , struct RastPort *, ___rp, a1, WORD, ___dx, d0, WORD, ___dy, d1, WORD, ___xMin, d2, WORD, ___yMin, d3, WORD, ___xMax, d4, WORD, ___yMax, d5,\
	, GRAPHICS_BASE_NAME)
...
#define WriteChunkyPixels(___rp, ___xstart, ___ystart, ___xstop, ___ystop, ___array, ___bytesperrow) \
	LP7NR(0x420, WriteChunkyPixels , struct RastPort *, ___rp, a0, UWORD, ___xstart, d0, UWORD, ___ystart, d1, UWORD, ___xstop, d2, UWORD, ___ystop, d3, const UBYTE *, ___array, a2, LONG, ___bytesperrow, d4,\
	, GRAPHICS_BASE_NAME)
